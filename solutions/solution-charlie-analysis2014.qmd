...
```{r}
#| label: functions
source(here("R/boxplot_study_state.R"))
source(here("R/clean_age_groups.R"))
source(here("R/clean_education_data.R"))
source(here("R/plot_study_age_state.R"))
source(here("R/summarise_prop_study.R"))
```
